...
declare module dojo
{
	class NodeList
	{
		...
		delegate(selector: string, eventName: "abort", listener: (ev: UIEvent) => void): dojo.NodeList;
		...
		delegate(selector: string, eventName: "beforeunload", listener: (ev: BeforeUnloadEvent) => void): dojo.NodeList;
		delegate(selector: string, eventName: "blur", listener: (ev: FocusEvent) => void): dojo.NodeList;
		...
		delegate(selector: string, eventName: "click", listener: (ev: MouseEvent) => void): dojo.NodeList;
		delegate(selector: string, eventName: "contextmenu", listener: (ev: MouseEvent) => void): dojo.NodeList;
		delegate(selector: string, eventName: "dblclick", listener: (ev: MouseEvent) => void): dojo.NodeList;
		delegate(selector: string, eventName: "drag", listener: (ev: DragEvent) => void): dojo.NodeList;
		delegate(selector: string, eventName: "dragend", listener: (ev: DragEvent) => void): dojo.NodeList;
		delegate(selector: string, eventName: "dragenter", listener: (ev: DragEvent) => void): dojo.NodeList;
		delegate(selector: string, eventName: "dragleave", listener: (ev: DragEvent) => void): dojo.NodeList;
		delegate(selector: string, eventName: "dragover", listener: (ev: DragEvent) => void): dojo.NodeList;
		delegate(selector: string, eventName: "dragstart", listener: (ev: DragEvent) => void): dojo.NodeList;
		delegate(selector: string, eventName: "drop", listener: (ev: DragEvent) => void): dojo.NodeList;
		...
		delegate(selector: string, eventName: "focus", listener: (ev: FocusEvent) => void): dojo.NodeList;
		...
		delegate(selector: string, eventName: "keydown", listener: (ev: KeyboardEvent) => void): dojo.NodeList;
		delegate(selector: string, eventName: "keypress", listener: (ev: KeyboardEvent) => void): dojo.NodeList;
		delegate(selector: string, eventName: "keyup", listener: (ev: KeyboardEvent) => void): dojo.NodeList;
		...
		delegate(selector: string, eventName: "message", listener: (ev: MessageEvent) => void): dojo.NodeList;
		delegate(selector: string, eventName: "mousedown", listener: (ev: MouseEvent) => void): dojo.NodeList;
		delegate(selector: string, eventName: "mousemove", listener: (ev: MouseEvent) => void): dojo.NodeList;
		delegate(selector: string, eventName: "mouseout", listener: (ev: MouseEvent) => void): dojo.NodeList;
		delegate(selector: string, eventName: "mouseover", listener: (ev: MouseEvent) => void): dojo.NodeList;
		delegate(selector: string, eventName: "mouseup", listener: (ev: MouseEvent) => void): dojo.NodeList;
		delegate(selector: string, eventName: "mousewheel", listener: (ev: MouseWheelEvent) => void): dojo.NodeList;
		...
		delegate(selector: string, eventName: "resize", listener: (ev: UIEvent) => void): dojo.NodeList;
		delegate(selector: string, eventName: "scroll", listener: (ev: UIEvent) => void): dojo.NodeList;
		...
		delegate(selector: string, eventName: "select", listener: (ev: UIEvent) => void): dojo.NodeList;
		delegate(selector: string, eventName: "stalled", listener: EventListener): dojo.NodeList;
		delegate(selector: string, eventName: "storage", listener: (ev: StorageEvent) => void): dojo.NodeList;
		...
		on(name: "abort", listener: (ev: UIEvent) => void): dojo.NodeList;
		on(name: "afterprint", listener: EventListener): dojo.NodeList;
		on(name: "beforeprint", listener: EventListener): dojo.NodeList;
		on(name: "beforeunload", listener: (ev: BeforeUnloadEvent) => void): dojo.NodeList;
		on(name: "blur", listener: (ev: FocusEvent) => void): dojo.NodeList;
		...
		on(name: "click", listener: (ev: MouseEvent) => void): dojo.NodeList;
		on(name: "contextmenu", listener: (ev: MouseEvent) => void): dojo.NodeList;
		on(name: "dblclick", listener: (ev: MouseEvent) => void): dojo.NodeList;
		on(name: "drag", listener: (ev: DragEvent) => void): dojo.NodeList;
		on(name: "dragend", listener: (ev: DragEvent) => void): dojo.NodeList;
		on(name: "dragenter", listener: (ev: DragEvent) => void): dojo.NodeList;
		on(name: "dragleave", listener: (ev: DragEvent) => void): dojo.NodeList;
		on(name: "dragover", listener: (ev: DragEvent) => void): dojo.NodeList;
		on(name: "dragstart", listener: (ev: DragEvent) => void): dojo.NodeList;
		on(name: "drop", listener: (ev: DragEvent) => void): dojo.NodeList;
		...
		on(name: "focus", listener: (ev: FocusEvent) => void): dojo.NodeList;
		on(name: "hashchange", listener: EventListener): dojo.NodeList;
		on(name: "input", listener: EventListener): dojo.NodeList;
		on(name: "keydown", listener: (ev: KeyboardEvent) => void): dojo.NodeList;
		on(name: "keypress", listener: (ev: KeyboardEvent) => void): dojo.NodeList;
		on(name: "keyup", listener: (ev: KeyboardEvent) => void): dojo.NodeList;
		...
		on(name: "message", listener: (ev: MessageEvent) => void): dojo.NodeList;
		on(name: "mousedown", listener: (ev: MouseEvent) => void): dojo.NodeList;
		on(name: "mousemove", listener: (ev: MouseEvent) => void): dojo.NodeList;
		on(name: "mouseout", listener: (ev: MouseEvent) => void): dojo.NodeList;
		on(name: "mouseover", listener: (ev: MouseEvent) => void): dojo.NodeList;
		on(name: "mouseup", listener: (ev: MouseEvent) => void): dojo.NodeList;
		on(name: "mousewheel", listener: (ev: MouseWheelEvent) => void): dojo.NodeList;
		...
		on(name: "resize", listener: (ev: UIEvent) => void): dojo.NodeList;
		on(name: "scroll", listener: (ev: UIEvent) => void): dojo.NodeList;
		on(name: "seeked", listener: EventListener): dojo.NodeList;
		on(name: "seeking", listener: EventListener): dojo.NodeList;
		on(name: "select", listener: (ev: UIEvent) => void): dojo.NodeList;
		on(name: "stalled", listener: EventListener): dojo.NodeList;
		on(name: "storage", listener: (ev: StorageEvent) => void): dojo.NodeList;
...
declare module Dojo
{
	interface On
	{
		(target: HTMLElement, type: "abort", listener: (ev: UIEvent) => void, dontFix?: boolean): Dojo.RemovableHandle;
		(target: HTMLElement, type: "afterprint", listener: EventListener, dontFix?: boolean): Dojo.RemovableHandle;
		(target: HTMLElement, type: "beforeprint", listener: EventListener, dontFix?: boolean): Dojo.RemovableHandle;
		(target: HTMLElement, type: "beforeunload", listener: (ev: BeforeUnloadEvent) => void, dontFix?: boolean): Dojo.RemovableHandle;
		(target: HTMLElement, type: "blur", listener: (ev: FocusEvent) => void, dontFix?: boolean): Dojo.RemovableHandle;
		(target: HTMLElement, type: "canplay", listener: EventListener, dontFix?: boolean): Dojo.RemovableHandle;
		(target: HTMLElement, type: "canplaythrough", listener: EventListener, dontFix?: boolean): Dojo.RemovableHandle;
		(target: HTMLElement, type: "change", listener: EventListener, dontFix?: boolean): Dojo.RemovableHandle;
		(target: HTMLElement, type: "click", listener: (ev: MouseEvent) => void, dontFix?: boolean): Dojo.RemovableHandle;
		(target: HTMLElement, type: "contextmenu", listener: (ev: MouseEvent) => void, dontFix?: boolean): Dojo.RemovableHandle;
		(target: HTMLElement, type: "dblclick", listener: (ev: MouseEvent) => void, dontFix?: boolean): Dojo.RemovableHandle;
		(target: HTMLElement, type: "drag", listener: (ev: DragEvent) => void, dontFix?: boolean): Dojo.RemovableHandle;
		(target: HTMLElement, type: "dragend", listener: (ev: DragEvent) => void, dontFix?: boolean): Dojo.RemovableHandle;
		(target: HTMLElement, type: "dragenter", listener: (ev: DragEvent) => void, dontFix?: boolean): Dojo.RemovableHandle;
		(target: HTMLElement, type: "dragleave", listener: (ev: DragEvent) => void, dontFix?: boolean): Dojo.RemovableHandle;
		(target: HTMLElement, type: "dragover", listener: (ev: DragEvent) => void, dontFix?: boolean): Dojo.RemovableHandle;
		(target: HTMLElement, type: "dragstart", listener: (ev: DragEvent) => void, dontFix?: boolean): Dojo.RemovableHandle;
		(target: HTMLElement, type: "drop", listener: (ev: DragEvent) => void, dontFix?: boolean): Dojo.RemovableHandle;
		(target: HTMLElement, type: "durationchange", listener: EventListener, dontFix?: boolean): Dojo.RemovableHandle;
		(target: HTMLElement, type: "emptied", listener: EventListener, dontFix?: boolean): Dojo.RemovableHandle;
		(target: HTMLElement, type: "ended", listener: EventListener, dontFix?: boolean): Dojo.RemovableHandle;
		(target: HTMLElement, type: "focus", listener: (ev: FocusEvent) => void, dontFix?: boolean): Dojo.RemovableHandle;
		(target: HTMLElement, type: "hashchange", listener: EventListener, dontFix?: boolean): Dojo.RemovableHandle;
		(target: HTMLElement, type: "input", listener: EventListener, dontFix?: boolean): Dojo.RemovableHandle;
		(target: HTMLElement, type: "keydown", listener: (ev: KeyboardEvent) => void, dontFix?: boolean): Dojo.RemovableHandle;
		(target: HTMLElement, type: "keypress", listener: (ev: KeyboardEvent) => void, dontFix?: boolean): Dojo.RemovableHandle;
		(target: HTMLElement, type: "keyup", listener: (ev: KeyboardEvent) => void, dontFix?: boolean): Dojo.RemovableHandle;
		(target: HTMLElement, type: "load", listener: EventListener, dontFix?: boolean): Dojo.RemovableHandle;
		(target: HTMLElement, type: "loadeddata", listener: EventListener, dontFix?: boolean): Dojo.RemovableHandle;
		(target: HTMLElement, type: "loadedmetadata", listener: EventListener, dontFix?: boolean): Dojo.RemovableHandle;
		(target: HTMLElement, type: "loadstart", listener: EventListener, dontFix?: boolean): Dojo.RemovableHandle;
		(target: HTMLElement, type: "message", listener: (ev: MessageEvent) => void, dontFix?: boolean): Dojo.RemovableHandle;
		(target: HTMLElement, type: "mousedown", listener: (ev: MouseEvent) => void, dontFix?: boolean): Dojo.RemovableHandle;
		(target: HTMLElement, type: "mousemove", listener: (ev: MouseEvent) => void, dontFix?: boolean): Dojo.RemovableHandle;
		(target: HTMLElement, type: "mouseout", listener: (ev: MouseEvent) => void, dontFix?: boolean): Dojo.RemovableHandle;
		(target: HTMLElement, type: "mouseover", listener: (ev: MouseEvent) => void, dontFix?: boolean): Dojo.RemovableHandle;
		(target: HTMLElement, type: "mouseup", listener: (ev: MouseEvent) => void, dontFix?: boolean): Dojo.RemovableHandle;
		(target: HTMLElement, type: "mousewheel", listener: (ev: MouseWheelEvent) => void, dontFix?: boolean): Dojo.RemovableHandle;
		(target: HTMLElement, type: "offline", listener: EventListener, dontFix?: boolean): Dojo.RemovableHandle;
		(target: HTMLElement, type: "online", listener: EventListener, dontFix?: boolean): Dojo.RemovableHandle;
		(target: HTMLElement, type: "pause", listener: EventListener, dontFix?: boolean): Dojo.RemovableHandle;
		(target: HTMLElement, type: "play", listener: EventListener, dontFix?: boolean): Dojo.RemovableHandle;
		(target: HTMLElement, type: "playing", listener: EventListener, dontFix?: boolean): Dojo.RemovableHandle;
		(target: HTMLElement, type: "progress", listener: (ev: any) => void, dontFix?: boolean): Dojo.RemovableHandle;
		(target: HTMLElement, type: "ratechange", listener: EventListener, dontFix?: boolean): Dojo.RemovableHandle;
		(target: HTMLElement, type: "readystatechange", listener: EventListener, dontFix?: boolean): Dojo.RemovableHandle;
		(target: HTMLElement, type: "reset", listener: EventListener, dontFix?: boolean): Dojo.RemovableHandle;
		(target: HTMLElement, type: "resize", listener: (ev: UIEvent) => void, dontFix?: boolean): Dojo.RemovableHandle;
		(target: HTMLElement, type: "scroll", listener: (ev: UIEvent) => void, dontFix?: boolean): Dojo.RemovableHandle;
		(target: HTMLElement, type: "seeked", listener: EventListener, dontFix?: boolean): Dojo.RemovableHandle;
		(target: HTMLElement, type: "seeking", listener: EventListener, dontFix?: boolean): Dojo.RemovableHandle;
		(target: HTMLElement, type: "select", listener: (ev: UIEvent) => void, dontFix?: boolean): Dojo.RemovableHandle;
		(target: HTMLElement, type: "stalled", listener: EventListener, dontFix?: boolean): Dojo.RemovableHandle;
		(target: HTMLElement, type: "storage", listener: (ev: StorageEvent) => void, dontFix?: boolean): Dojo.RemovableHandle;
		(target: HTMLElement, type: "submit", listener: EventListener, dontFix?: boolean): Dojo.RemovableHandle;
		(target: HTMLElement, type: "suspend", listener: EventListener, dontFix?: boolean): Dojo.RemovableHandle;
		(target: HTMLElement, type: "timeupdate", listener: EventListener, dontFix?: boolean): Dojo.RemovableHandle;
		(target: HTMLElement, type: "unload", listener: EventListener, dontFix?: boolean): Dojo.RemovableHandle;
		(target: HTMLElement, type: "volumechange", listener: EventListener, dontFix?: boolean): Dojo.RemovableHandle;
		(target: HTMLElement, type: "waiting", listener: EventListener, dontFix?: boolean): Dojo.RemovableHandle;
		...
		pausable(target: HTMLElement, type: "abort", listener: (ev: UIEvent) => void, dontFix?: boolean): Dojo.RemovableHandle;
		pausable(target: HTMLElement, type: "afterprint", listener: EventListener, dontFix?: boolean): Dojo.RemovableHandle;
		pausable(target: HTMLElement, type: "beforeprint", listener: EventListener, dontFix?: boolean): Dojo.RemovableHandle;
		pausable(target: HTMLElement, type: "beforeunload", listener: (ev: BeforeUnloadEvent) => void, dontFix?: boolean): Dojo.RemovableHandle;
		pausable(target: HTMLElement, type: "blur", listener: (ev: FocusEvent) => void, dontFix?: boolean): Dojo.RemovableHandle;
		pausable(target: HTMLElement, type: "canplay", listener: EventListener, dontFix?: boolean): Dojo.RemovableHandle;
		pausable(target: HTMLElement, type: "canplaythrough", listener: EventListener, dontFix?: boolean): Dojo.RemovableHandle;
		pausable(target: HTMLElement, type: "change", listener: EventListener, dontFix?: boolean): Dojo.RemovableHandle;
		pausable(target: HTMLElement, type: "click", listener: (ev: MouseEvent) => void, dontFix?: boolean): Dojo.RemovableHandle;
		pausable(target: HTMLElement, type: "contextmenu", listener: (ev: MouseEvent) => void, dontFix?: boolean): Dojo.RemovableHandle;
		pausable(target: HTMLElement, type: "dblclick", listener: (ev: MouseEvent) => void, dontFix?: boolean): Dojo.RemovableHandle;
		pausable(target: HTMLElement, type: "drag", listener: (ev: DragEvent) => void, dontFix?: boolean): Dojo.RemovableHandle;
		pausable(target: HTMLElement, type: "dragend", listener: (ev: DragEvent) => void, dontFix?: boolean): Dojo.RemovableHandle;
		pausable(target: HTMLElement, type: "dragenter", listener: (ev: DragEvent) => void, dontFix?: boolean): Dojo.RemovableHandle;
		pausable(target: HTMLElement, type: "dragleave", listener: (ev: DragEvent) => void, dontFix?: boolean): Dojo.RemovableHandle;
		pausable(target: HTMLElement, type: "dragover", listener: (ev: DragEvent) => void, dontFix?: boolean): Dojo.RemovableHandle;
		pausable(target: HTMLElement, type: "dragstart", listener: (ev: DragEvent) => void, dontFix?: boolean): Dojo.RemovableHandle;
		pausable(target: HTMLElement, type: "drop", listener: (ev: DragEvent) => void, dontFix?: boolean): Dojo.RemovableHandle;
		pausable(target: HTMLElement, type: "durationchange", listener: EventListener, dontFix?: boolean): Dojo.RemovableHandle;
		pausable(target: HTMLElement, type: "emptied", listener: EventListener, dontFix?: boolean): Dojo.RemovableHandle;
		pausable(target: HTMLElement, type: "ended", listener: EventListener, dontFix?: boolean): Dojo.RemovableHandle;
		pausable(target: HTMLElement, type: "focus", listener: (ev: FocusEvent) => void, dontFix?: boolean): Dojo.RemovableHandle;
		pausable(target: HTMLElement, type: "hashchange", listener: EventListener, dontFix?: boolean): Dojo.RemovableHandle;
		pausable(target: HTMLElement, type: "input", listener: EventListener, dontFix?: boolean): Dojo.RemovableHandle;
		pausable(target: HTMLElement, type: "keydown", listener: (ev: KeyboardEvent) => void, dontFix?: boolean): Dojo.RemovableHandle;
		pausable(target: HTMLElement, type: "keypress", listener: (ev: KeyboardEvent) => void, dontFix?: boolean): Dojo.RemovableHandle;
		pausable(target: HTMLElement, type: "keyup", listener: (ev: KeyboardEvent) => void, dontFix?: boolean): Dojo.RemovableHandle;
		pausable(target: HTMLElement, type: "load", listener: EventListener, dontFix?: boolean): Dojo.RemovableHandle;
		pausable(target: HTMLElement, type: "loadeddata", listener: EventListener, dontFix?: boolean): Dojo.RemovableHandle;
		pausable(target: HTMLElement, type: "loadedmetadata", listener: EventListener, dontFix?: boolean): Dojo.RemovableHandle;
		pausable(target: HTMLElement, type: "loadstart", listener: EventListener, dontFix?: boolean): Dojo.RemovableHandle;
		pausable(target: HTMLElement, type: "message", listener: (ev: MessageEvent) => void, dontFix?: boolean): Dojo.RemovableHandle;
		pausable(target: HTMLElement, type: "mousedown", listener: (ev: MouseEvent) => void, dontFix?: boolean): Dojo.RemovableHandle;
		pausable(target: HTMLElement, type: "mousemove", listener: (ev: MouseEvent) => void, dontFix?: boolean): Dojo.RemovableHandle;
		pausable(target: HTMLElement, type: "mouseout", listener: (ev: MouseEvent) => void, dontFix?: boolean): Dojo.RemovableHandle;
		pausable(target: HTMLElement, type: "mouseover", listener: (ev: MouseEvent) => void, dontFix?: boolean): Dojo.RemovableHandle;
		pausable(target: HTMLElement, type: "mouseup", listener: (ev: MouseEvent) => void, dontFix?: boolean): Dojo.RemovableHandle;
		pausable(target: HTMLElement, type: "mousewheel", listener: (ev: MouseWheelEvent) => void, dontFix?: boolean): Dojo.RemovableHandle;
		pausable(target: HTMLElement, type: "offline", listener: EventListener, dontFix?: boolean): Dojo.RemovableHandle;
		pausable(target: HTMLElement, type: "online", listener: EventListener, dontFix?: boolean): Dojo.RemovableHandle;
		pausable(target: HTMLElement, type: "pause", listener: EventListener, dontFix?: boolean): Dojo.RemovableHandle;
		pausable(target: HTMLElement, type: "play", listener: EventListener, dontFix?: boolean): Dojo.RemovableHandle;
		pausable(target: HTMLElement, type: "playing", listener: EventListener, dontFix?: boolean): Dojo.RemovableHandle;
		pausable(target: HTMLElement, type: "progress", listener: (ev: any) => void, dontFix?: boolean): Dojo.RemovableHandle;
		pausable(target: HTMLElement, type: "ratechange", listener: EventListener, dontFix?: boolean): Dojo.RemovableHandle;
		pausable(target: HTMLElement, type: "readystatechange", listener: EventListener, dontFix?: boolean): Dojo.RemovableHandle;
		pausable(target: HTMLElement, type: "reset", listener: EventListener, dontFix?: boolean): Dojo.RemovableHandle;
		pausable(target: HTMLElement, type: "resize", listener: (ev: UIEvent) => void, dontFix?: boolean): Dojo.RemovableHandle;
		pausable(target: HTMLElement, type: "scroll", listener: (ev: UIEvent) => void, dontFix?: boolean): Dojo.RemovableHandle;
		pausable(target: HTMLElement, type: "seeked", listener: EventListener, dontFix?: boolean): Dojo.RemovableHandle;
		pausable(target: HTMLElement, type: "seeking", listener: EventListener, dontFix?: boolean): Dojo.RemovableHandle;
		pausable(target: HTMLElement, type: "select", listener: (ev: UIEvent) => void, dontFix?: boolean): Dojo.RemovableHandle;
		pausable(target: HTMLElement, type: "stalled", listener: EventListener, dontFix?: boolean): Dojo.RemovableHandle;
		pausable(target: HTMLElement, type: "storage", listener: (ev: StorageEvent) => void, dontFix?: boolean): Dojo.RemovableHandle;
		pausable(target: HTMLElement, type: "submit", listener: EventListener, dontFix?: boolean): Dojo.RemovableHandle;
		pausable(target: HTMLElement, type: "suspend", listener: EventListener, dontFix?: boolean): Dojo.RemovableHandle;
		pausable(target: HTMLElement, type: "timeupdate", listener: EventListener, dontFix?: boolean): Dojo.RemovableHandle;
		pausable(target: HTMLElement, type: "unload", listener: EventListener, dontFix?: boolean): Dojo.RemovableHandle;
		pausable(target: HTMLElement, type: "volumechange", listener: EventListener, dontFix?: boolean): Dojo.RemovableHandle;
		pausable(target: HTMLElement, type: "waiting", listener: EventListener, dontFix?: boolean): Dojo.RemovableHandle;
		pausable(target: HTMLElement, type: string, listener: EventListener, dontFix?: boolean): Dojo.RemovableHandle;
		...
		once(target: HTMLElement, type: "afterprint", listener: EventListener, dontFix?: boolean): Dojo.RemovableHandle;
		once(target: HTMLElement, type: "beforeprint", listener: EventListener, dontFix?: boolean): Dojo.RemovableHandle;
		once(target: HTMLElement, type: "beforeunload", listener: (ev: BeforeUnloadEvent) => void, dontFix?: boolean): Dojo.RemovableHandle;
		once(target: HTMLElement, type: "blur", listener: (ev: FocusEvent) => void, dontFix?: boolean): Dojo.RemovableHandle;
		once(target: HTMLElement, type: "canplay", listener: EventListener, dontFix?: boolean): Dojo.RemovableHandle;
		once(target: HTMLElement, type: "canplaythrough", listener: EventListener, dontFix?: boolean): Dojo.RemovableHandle;
		once(target: HTMLElement, type: "change", listener: EventListener, dontFix?: boolean): Dojo.RemovableHandle;
		once(target: HTMLElement, type: "click", listener: (ev: MouseEvent) => void, dontFix?: boolean): Dojo.RemovableHandle;
		once(target: HTMLElement, type: "contextmenu", listener: (ev: MouseEvent) => void, dontFix?: boolean): Dojo.RemovableHandle;
		once(target: HTMLElement, type: "dblclick", listener: (ev: MouseEvent) => void, dontFix?: boolean): Dojo.RemovableHandle;
		once(target: HTMLElement, type: "drag", listener: (ev: DragEvent) => void, dontFix?: boolean): Dojo.RemovableHandle;
		once(target: HTMLElement, type: "dragend", listener: (ev: DragEvent) => void, dontFix?: boolean): Dojo.RemovableHandle;
		once(target: HTMLElement, type: "dragenter", listener: (ev: DragEvent) => void, dontFix?: boolean): Dojo.RemovableHandle;
		once(target: HTMLElement, type: "dragleave", listener: (ev: DragEvent) => void, dontFix?: boolean): Dojo.RemovableHandle;
		once(target: HTMLElement, type: "dragover", listener: (ev: DragEvent) => void, dontFix?: boolean): Dojo.RemovableHandle;
		once(target: HTMLElement, type: "dragstart", listener: (ev: DragEvent) => void, dontFix?: boolean): Dojo.RemovableHandle;
		once(target: HTMLElement, type: "drop", listener: (ev: DragEvent) => void, dontFix?: boolean): Dojo.RemovableHandle;
		once(target: HTMLElement, type: "durationchange", listener: EventListener, dontFix?: boolean): Dojo.RemovableHandle;
		once(target: HTMLElement, type: "emptied", listener: EventListener, dontFix?: boolean): Dojo.RemovableHandle;
		once(target: HTMLElement, type: "ended", listener: EventListener, dontFix?: boolean): Dojo.RemovableHandle;
		once(target: HTMLElement, type: "focus", listener: (ev: FocusEvent) => void, dontFix?: boolean): Dojo.RemovableHandle;
		once(target: HTMLElement, type: "hashchange", listener: EventListener, dontFix?: boolean): Dojo.RemovableHandle;
		once(target: HTMLElement, type: "input", listener: EventListener, dontFix?: boolean): Dojo.RemovableHandle;
		once(target: HTMLElement, type: "keydown", listener: (ev: KeyboardEvent) => void, dontFix?: boolean): Dojo.RemovableHandle;
		once(target: HTMLElement, type: "keypress", listener: (ev: KeyboardEvent) => void, dontFix?: boolean): Dojo.RemovableHandle;
		once(target: HTMLElement, type: "keyup", listener: (ev: KeyboardEvent) => void, dontFix?: boolean): Dojo.RemovableHandle;
		once(target: HTMLElement, type: "load", listener: EventListener, dontFix?: boolean): Dojo.RemovableHandle;
		once(target: HTMLElement, type: "loadeddata", listener: EventListener, dontFix?: boolean): Dojo.RemovableHandle;
		once(target: HTMLElement, type: "loadedmetadata", listener: EventListener, dontFix?: boolean): Dojo.RemovableHandle;
		once(target: HTMLElement, type: "loadstart", listener: EventListener, dontFix?: boolean): Dojo.RemovableHandle;
		once(target: HTMLElement, type: "message", listener: (ev: MessageEvent) => void, dontFix?: boolean): Dojo.RemovableHandle;
		once(target: HTMLElement, type: "mousedown", listener: (ev: MouseEvent) => void, dontFix?: boolean): Dojo.RemovableHandle;
		once(target: HTMLElement, type: "mousemove", listener: (ev: MouseEvent) => void, dontFix?: boolean): Dojo.RemovableHandle;
		once(target: HTMLElement, type: "mouseout", listener: (ev: MouseEvent) => void, dontFix?: boolean): Dojo.RemovableHandle;
		once(target: HTMLElement, type: "mouseover", listener: (ev: MouseEvent) => void, dontFix?: boolean): Dojo.RemovableHandle;
		once(target: HTMLElement, type: "mouseup", listener: (ev: MouseEvent) => void, dontFix?: boolean): Dojo.RemovableHandle;
		once(target: HTMLElement, type: "mousewheel", listener: (ev: MouseWheelEvent) => void, dontFix?: boolean): Dojo.RemovableHandle;
		once(target: HTMLElement, type: "offline", listener: EventListener, dontFix?: boolean): Dojo.RemovableHandle;
		once(target: HTMLElement, type: "online", listener: EventListener, dontFix?: boolean): Dojo.RemovableHandle;
		once(target: HTMLElement, type: "pause", listener: EventListener, dontFix?: boolean): Dojo.RemovableHandle;
		once(target: HTMLElement, type: "play", listener: EventListener, dontFix?: boolean): Dojo.RemovableHandle;
		once(target: HTMLElement, type: "playing", listener: EventListener, dontFix?: boolean): Dojo.RemovableHandle;
		once(target: HTMLElement, type: "progress", listener: (ev: any) => void, dontFix?: boolean): Dojo.RemovableHandle;
		once(target: HTMLElement, type: "ratechange", listener: EventListener, dontFix?: boolean): Dojo.RemovableHandle;
		once(target: HTMLElement, type: "readystatechange", listener: EventListener, dontFix?: boolean): Dojo.RemovableHandle;
		once(target: HTMLElement, type: "reset", listener: EventListener, dontFix?: boolean): Dojo.RemovableHandle;
		once(target: HTMLElement, type: "resize", listener: (ev: UIEvent) => void, dontFix?: boolean): Dojo.RemovableHandle;
		once(target: HTMLElement, type: "scroll", listener: (ev: UIEvent) => void, dontFix?: boolean): Dojo.RemovableHandle;
		once(target: HTMLElement, type: "seeked", listener: EventListener, dontFix?: boolean): Dojo.RemovableHandle;
		once(target: HTMLElement, type: "seeking", listener: EventListener, dontFix?: boolean): Dojo.RemovableHandle;
		once(target: HTMLElement, type: "select", listener: (ev: UIEvent) => void, dontFix?: boolean): Dojo.RemovableHandle;
		once(target: HTMLElement, type: "stalled", listener: EventListener, dontFix?: boolean): Dojo.RemovableHandle;
		once(target: HTMLElement, type: "storage", listener: (ev: StorageEvent) => void, dontFix?: boolean): Dojo.RemovableHandle;
		once(target: HTMLElement, type: "submit", listener: EventListener, dontFix?: boolean): Dojo.RemovableHandle;
		once(target: HTMLElement, type: "suspend", listener: EventListener, dontFix?: boolean): Dojo.RemovableHandle;
		once(target: HTMLElement, type: "timeupdate", listener: EventListener, dontFix?: boolean): Dojo.RemovableHandle;
		once(target: HTMLElement, type: "unload", listener: EventListener, dontFix?: boolean): Dojo.RemovableHandle;
		once(target: HTMLElement, type: "volumechange", listener: EventListener, dontFix?: boolean): Dojo.RemovableHandle;
		once(target: HTMLElement, type: "waiting", listener: EventListener, dontFix?: boolean): Dojo.RemovableHandle;
