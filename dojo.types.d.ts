...
declare module dojo
{
	...
	class Evented
	{
		...
		on(type: "abort", listener: (ev: UIEvent) => void): Dojo.RemovableHandle;
		...
		on(type: "beforeunload", listener: (ev: BeforeUnloadEvent) => void): Dojo.RemovableHandle;
		on(type: "blur", listener: (ev: FocusEvent) => void): Dojo.RemovableHandle;
		...
		on(type: "contextmenu", listener: (ev: MouseEvent) => void): Dojo.RemovableHandle;
		on(type: "dblclick", listener: (ev: MouseEvent) => void): Dojo.RemovableHandle;
		on(type: "drag", listener: (ev: DragEvent) => void): Dojo.RemovableHandle;
		on(type: "dragend", listener: (ev: DragEvent) => void): Dojo.RemovableHandle;
		on(type: "dragenter", listener: (ev: DragEvent) => void): Dojo.RemovableHandle;
		on(type: "dragleave", listener: (ev: DragEvent) => void): Dojo.RemovableHandle;
		on(type: "dragover", listener: (ev: DragEvent) => void): Dojo.RemovableHandle;
		on(type: "dragstart", listener: (ev: DragEvent) => void): Dojo.RemovableHandle;
		on(type: "drop", listener: (ev: DragEvent) => void): Dojo.RemovableHandle;
		...
		on(type: "focus", listener: (ev: FocusEvent) => void): Dojo.RemovableHandle;
		...
		on(type: "message", listener: (ev: MessageEvent) => void): Dojo.RemovableHandle;
		...
		on(type: "mousewheel", listener: (ev: MouseWheelEvent) => void): Dojo.RemovableHandle;
		...
		on(type: "resize", listener: (ev: UIEvent) => void): Dojo.RemovableHandle;
		on(type: "scroll", listener: (ev: UIEvent) => void): Dojo.RemovableHandle;
		on(type: "seeked", listener: EventListener): Dojo.RemovableHandle;
		on(type: "seeking", listener: EventListener): Dojo.RemovableHandle;
		on(type: "select", listener: (ev: UIEvent) => void): Dojo.RemovableHandle;
		on(type: "stalled", listener: EventListener): Dojo.RemovableHandle;
		on(type: "storage", listener: (ev: StorageEvent) => void): Dojo.RemovableHandle;
